...
When you need to setup a new environment, use `pip install -m requirements.txt` to load the required packages stored in the corresponding [**file**](st185873/Modeling_Semantic_Plausibility/requirements.txt).
